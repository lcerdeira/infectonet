...
const CLINICAL_DB: Record<string, ClinicalInfo> = {
  ...
  avianflu: {
    ...
    transmission: [
      ...
      '⚠️ 2023–2026: HPAI documented in Antarctic penguins (gentoo, chinstrap, king) and sub-Antarctic seabirds — unprecedented geographic range',
      '⚠️ Polar bear (Ursus maritimus) — Alaska, USA: H5N1 clade 2.3.4.4b, North Slope Borough. First polar bear globally (Elsmo et al., Emerg Infect Dis 2024, PMID 38941966).',
      '⚠️ NEW 2026 — Svalbard, Raudfjorden (H5N5): Polar bear (1-yr male) + adult walrus found dead. TWO additional polar bears with hind leg paralysis (neurological). First polar bear in Norway/Europe. FIRST WALRUS globally with HPAI. (Norwegian Veterinary Institute, 19 May 2026). H5N5 = same subtype as first human H5N5 case ever (USA, Dec 2025).',
      '⚠️ Svalbard/Norway additional species: Arctic fox (2025), walrus (2023 — first detection). Mainland Norway: red fox, otter, lynx confirmed positive after exposure to infected wild birds.',
      '⚠️ Black bears (Ursus americanus) x2 — Québec, Canada: meningoencephalitis; D701N PB2 mutation (mammalian adaptation). PMID 37735770.',
      '2024–2025: US dairy cattle; 71 human H5N1 cases in farm workers; Dec 2025: first ever H5N5 human case globally (USA, 71st total H5 case).',
    ],
    symptoms: [
    ...
    variants: [
      { name: 'H5N1 clade 2.3.4.4b', abbr: 'H5N1', geography: 'Global — all 7 continents', notes: 'Dominant HPAI strain since 2021. Confirmed in: black bears (Québec), sea lions (S. America), seals, dolphins, mink, foxes, cats, dairy cattle (USA). D701N PB2 mutation = mammalian adaptation signal.' },
      { name: 'H5N5 — Svalbard 2026', abbr: 'H5N5 ⚠️', geography: 'Svalbard (Arctic) + USA (first human 2025)', notes: 'NEW 2026: Polar bear + walrus, Raudfjorden, Spitsbergen. Arctic fox (2025), lynx + otter (mainland Norway). First human H5N5 case ever: USA, Dec 2025. Same subtype in both Arctic wildlife and US human patient — warrants urgent monitoring for mammalian adaptation.' },
      { name: 'H5N2', abbr: 'H5N2', geography: 'USA (poultry), historical Asia', notes: 'HPAI; major US poultry outbreak 2015; 50M+ birds culled; first human case Mexico 2024' },
